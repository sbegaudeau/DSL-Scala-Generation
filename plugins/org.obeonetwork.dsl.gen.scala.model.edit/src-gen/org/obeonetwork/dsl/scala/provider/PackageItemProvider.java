...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.scala.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScalaPackage.Literals.PACKAGE__SUPER_PACKAGE,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ScalaPackage.Literals.PACKAGE__FILES);
      childrenFeatures.add(ScalaPackage.Literals.PACKAGE__SUB_PACKAGES);
    }
  ...
  {
    String label = ((org.obeonetwork.dsl.scala.Package)object).getName();
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(org.obeonetwork.dsl.scala.Package.class))
    {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ScalaPackage.Literals.PACKAGE__FILES,
         ScalaFactory.eINSTANCE.createFile()));

    newChildDescriptors.add
      (createChildParameter
        (ScalaPackage.Literals.PACKAGE__SUB_PACKAGES,
