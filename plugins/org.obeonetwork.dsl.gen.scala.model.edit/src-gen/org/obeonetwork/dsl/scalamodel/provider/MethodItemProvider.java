...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.scalamodel.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScalamodelPackage.Literals.METHOD__ABSTRACT,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScalamodelPackage.Literals.METHOD__FINAL,
         true,
         false,
         false,
         ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
  ...
  protected void addOverridingPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Method_overriding_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Method_overriding_feature", "_UI_Method_type"),
         ScalamodelPackage.Literals.METHOD__OVERRIDING,
         true,
         false,
         false,
         ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ScalamodelPackage.Literals.METHOD__SIGNATURE);
      childrenFeatures.add(ScalamodelPackage.Literals.METHOD__VISIBILITY);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ScalamodelPackage.Literals.METHOD__SIGNATURE,
         ScalamodelFactory.eINSTANCE.createSignature()));

    newChildDescriptors.add
      (createChildParameter
        (ScalamodelPackage.Literals.METHOD__VISIBILITY,
         ScalamodelFactory.eINSTANCE.createVisibility()));
  }
