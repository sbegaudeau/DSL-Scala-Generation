...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.scalamodel.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScalamodelPackage.Literals.PACKAGE__SUPER_PACKAGE,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ScalamodelPackage.Literals.PACKAGE__FILES);
      childrenFeatures.add(ScalamodelPackage.Literals.PACKAGE__SUB_PACKAGES);
    }
  ...
  {
    String label = ((org.obeonetwork.dsl.scalamodel.Package)object).getName();
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(org.obeonetwork.dsl.scalamodel.Package.class))
    {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ScalamodelPackage.Literals.PACKAGE__FILES,
         ScalamodelFactory.eINSTANCE.createFile()));

    newChildDescriptors.add
      (createChildParameter
        (ScalamodelPackage.Literals.PACKAGE__SUB_PACKAGES,
         ScalamodelFactory.eINSTANCE.createPackage()));
  }
