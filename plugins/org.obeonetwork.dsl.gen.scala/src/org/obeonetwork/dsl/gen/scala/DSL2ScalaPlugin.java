 ...
 *******************************************************************************/
package org.obeonetwork.dsl.gen.scala;
 ...
 */
public class DSL2ScalaPlugin extends Plugin {

    /**
     * The plug-in ID.
     */
    public static final String PLUGIN_ID = "org.obeonetwork.dsl.gen.scala";

    /**
     * The shared instance.
     */
    private static DSL2ScalaPlugin plugin;
    
    /**
     * The constructor.
     */
    public DSL2ScalaPlugin() {
    }
     ...
     */
    public static DSL2ScalaPlugin getDefault() {
        return plugin;
    }
	...
	public static void log(Exception e, boolean blocker) {
		if (e == null) {
			throw new NullPointerException("Logging null exception"); //$NON-NLS-1$
		}
	...
	public static void log(IStatus status) {
		...
		if (status == null) {
			throw new NullPointerException("Logging null status"); //$NON-NLS-1$
		}
