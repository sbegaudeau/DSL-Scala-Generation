 ...
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FileImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FileImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FileImpl#getClassifiers <em>Classifiers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileImpl extends MinimalEObjectImpl.Container implements File
{
  ...
  public void setOwnedComment(String newOwnedComment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FILE__OWNED_COMMENT, oldOwnedComment, ownedComment));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FILE__NAME, oldName, name));
  }
  ...
  public EList<Classifier> getClassifiers()
  {
    if (classifiers == null)
    {
      classifiers = new EObjectContainmentEList<Classifier>(Classifier.class, this, ScalaPackage.FILE__CLASSIFIERS);
    }
    return classifiers;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ScalaPackage.FILE__OWNED_COMMENT:
