 ...
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.TraitImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.TraitImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.TraitImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.TraitImpl#getMethods <em>Methods</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.TraitImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.TraitImpl#getTraits <em>Traits</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.TraitImpl#isSealed <em>Sealed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TraitImpl extends MinimalEObjectImpl.Container implements Trait
{
  ...
  public void setOwnedComment(String newOwnedComment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.TRAIT__OWNED_COMMENT, oldOwnedComment, ownedComment));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.TRAIT__NAME, oldName, name));
  }
  ...
  public EList<Field> getFields()
  {
    if (fields == null)
    {
      fields = new EObjectContainmentEList<Field>(Field.class, this, ScalaPackage.TRAIT__FIELDS);
    }
    return fields;
  }
  ...
  public EList<Method> getMethods()
  {
    if (methods == null)
    {
      methods = new EObjectContainmentEList<Method>(Method.class, this, ScalaPackage.TRAIT__METHODS);
    }
    return methods;
  }
  ...
  public ExtendableClassifier getSuperType()
  {
    if (superType != null && superType.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ScalaPackage.TRAIT__SUPER_TYPE, oldSuperType, superType));
      }
    }
    return superType;
  }
  ...
  public void setSuperType(ExtendableClassifier newSuperType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.TRAIT__SUPER_TYPE, oldSuperType, superType));
  }
  ...
  public EList<Trait> getTraits()
  {
    if (traits == null)
    {
      traits = new EObjectResolvingEList<Trait>(Trait.class, this, ScalaPackage.TRAIT__TRAITS);
    }
    return traits;
  }
  ...
  public void setSealed(boolean newSealed)
  {
    ...
    sealed = newSealed;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.TRAIT__SEALED, oldSealed, sealed));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ScalaPackage.TRAIT__OWNED_COMMENT:
      ...
      case ScalaPackage.TRAIT__TRAITS:
        return getTraits();
      case ScalaPackage.TRAIT__SEALED:
        return isSealed();
    }
