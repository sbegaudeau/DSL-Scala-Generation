 ...
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FieldImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FieldImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FieldImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FieldImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FieldImpl#isConstructorProperty <em>Constructor Property</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FieldImpl#isFinal <em>Final</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FieldImpl#isOverriding <em>Overriding</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.scala.impl.FieldImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FieldImpl extends MinimalEObjectImpl.Container implements Field
{
  ...
  public void setOwnedComment(String newOwnedComment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__OWNED_COMMENT, oldOwnedComment, ownedComment));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetType(Type newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__TYPE, oldType, newType);
  ...
  public void setType(Type newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ScalaPackage.FIELD__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ScalaPackage.FIELD__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__TYPE, newType, newType));
  }
  ...
  public void setOptional(boolean newOptional)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__OPTIONAL, oldOptional, optional));
  }
  ...
  public void setConstructorProperty(boolean newConstructorProperty)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__CONSTRUCTOR_PROPERTY, oldConstructorProperty, constructorProperty));
  }
  ...
  public void setFinal(boolean newFinal)
  {
    ...
    final_ = newFinal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__FINAL, oldFinal, final_));
  }
  ...
  public void setOverriding(boolean newOverriding)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__OVERRIDING, oldOverriding, overriding));
  }
  ...
  public NotificationChain basicSetVisibility(Visibility newVisibility, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__VISIBILITY, oldVisibility, newVisibility);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setVisibility(Visibility newVisibility)
  {
    if (newVisibility != visibility)
    {
      NotificationChain msgs = null;
      if (visibility != null)
        msgs = ((InternalEObject)visibility).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ScalaPackage.FIELD__VISIBILITY, null, msgs);
      if (newVisibility != null)
        msgs = ((InternalEObject)newVisibility).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ScalaPackage.FIELD__VISIBILITY, null, msgs);
      msgs = basicSetVisibility(newVisibility, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScalaPackage.FIELD__VISIBILITY, newVisibility, newVisibility));
  }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == TypedElement.class)
    {
      ...
      {
        case ScalaPackage.FIELD__TYPE: return ScalaPackage.TYPED_ELEMENT__TYPE;
        case ScalaPackage.FIELD__OPTIONAL: return ScalaPackage.TYPED_ELEMENT__OPTIONAL;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == TypedElement.class)
    {
      ...
      {
        case ScalaPackage.TYPED_ELEMENT__TYPE: return ScalaPackage.FIELD__TYPE;
        case ScalaPackage.TYPED_ELEMENT__OPTIONAL: return ScalaPackage.FIELD__OPTIONAL;
        default: return -1;
      }
    }
